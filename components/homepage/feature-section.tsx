...
const FeatureSection = () => {
  return (
    <div className="w-full max-w-4xl mx-auto">
      <h1 className="text-xl text-left font-bold px-4 md:px-0">All Projects</h1>
      {/* cards container */}
      <div className="flex flex-col px-4 md:px-0 md:flex-row gap-3 pt-4 pb-16 border-b border-gray-200">
        {/* card 1 */}
